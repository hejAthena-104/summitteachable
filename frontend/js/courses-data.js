  ...
  var COURSES = [
    {
      ...
      level: "beginner",
      price: 1000,
      blurb: "Spot repeatable, high-probability setups in the stock market — order flow, imbalance and clean entries, demo only.",
      lessons: 8,
      hours: "4h 15m",
    ...
    },
    {
      ...
      level: "beginner",
      price: 1000,
      blurb: "A from-scratch roadmap for the brand-new trader — markets, brokers and your first simulated trade on a paper account.",
      lessons: 9,
      hours: "6h 30m",
    ...
    },
    {
      ...
      level: "intermediate",
      price: 1000,
      blurb: "Leverage, contracts and margin explained and practiced risk-free — ticks, multipliers and intraday execution.",
      lessons: 6,
      hours: "5h 45m",
    ...
    },
    {
      ...
      level: "intermediate",
      price: 1000,
      blurb: "Calls, puts and spreads demystified — paper-trade covered calls, verticals and defined-risk plays.",
      lessons: 8,
      hours: "7h 10m",
    ...
    },
    {
      ...
      level: "beginner",
      price: 1000,
      blurb: "One curriculum, two asset classes — wallets, swaps and equities, all on the Summit demo platform.",
      lessons: 8,
      hours: "8h 00m",
    ...
    },
    {
      ...
      level: "advanced",
      price: 1000,
      blurb: "Profiting in down markets with hedges and shorts — borrow, margin and drawdown management on play money.",
      lessons: 6,
      hours: "6h 50m",
    ...
    },
    {
      ...
      level: "intermediate",
      price: 1000,
      blurb: "Master the mental game and protect your demo capital — discipline, journaling and position-sizing rules.",
      lessons: 6,
      hours: "4h 40m",
